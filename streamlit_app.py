...
options = []  #multile locations options for a city of the same name
def main():
    ...
    if st.button("Go") or 'go' in st.session_state:  # e.g. 'Birmingham' #'Saint Petersburg' #'Jerusalem' #London
